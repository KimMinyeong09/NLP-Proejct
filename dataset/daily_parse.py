...
if __name__ == '__main__':
    main(sys.argv[1:])
    # python .\parser.py -i .\ijcnlp_dailydialog\ijcnlp_dailydialog\validation\validation -o .\ijcnlp_dailydialog\ijcnlp_dailydialog\parsed_data
